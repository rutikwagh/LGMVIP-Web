...
<body>
    ...
    <div class="title">
        ...
        <a href="logout.php" style="color: black,float:left;"><span class="fa fa-sign-out fa-2x">Logout</span></a>
    </div>
...
<br><br><br><br>
<footer>
        <p>©©®®™copyrights reserved to Rutik Wagh⬛⬛⬛</p>
        <p><a href="mailto:waghrutik111@gmail.com">waghrutik111@gmail.com</a></p>
      </footer>
