    ...
    <div class="main">
        ...
        <form action="" method="post">
            <fieldset>
                ...
                <?php
                    ...
                    echo'</select>'
                ?>
                <input type="number" name="rno" placeholder="Roll No" .require>
        ...
        <form action="" method="post">
            <fieldset>
                ...
                <input type="number" name="rn" placeholder="Roll No" .require>
                <input type="number" name="p1" id="" placeholder="Paper 1" .require>
                <input type="number" name="p2" id="" placeholder="Paper 2" .require>
                <input type="number" name="p3" id="" placeholder="Paper 3" .require>
                <input type="number" name="p4" id="" placeholder="Paper 4" .require>
                <input type="number" name="p5" id="" placeholder="Paper 5" .require>
